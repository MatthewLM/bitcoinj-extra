...
package org.bitcoinj_extra.examples;

import org.bitcoinj_extra.core.*;
import org.bitcoinj_extra.kits.WalletAppKit;
...
/**
 * The following example shows how to use the by bitcoinj_extra provided WalletAppKit.
 * The WalletAppKit class wraps the boilerplate (Peers, BlockChain, BlockStorage, Wallet) needed to set up a new SPV bitcoinj_extra app.
 * 
...
public class Kit {
    ...
    public static void main(String[] args) {
        ...
        // bitcoinj_extra is working a lot with the Google Guava libraries. The WalletAppKit extends the AbstractIdleService. Have a look at the introduction to Guava services: https://github.com/google/guava/wiki/ServiceExplained
        kit.startAsync();
        kit.awaitRunning();
