...
import org.bitcoinj_extra.testing.TestWithWallet;
...
import org.bitcoinj_extra.wallet.WalletFiles;
...
import static org.bitcoinj_extra.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.bitcoinj_extra.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.bitcoinj_extra.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
