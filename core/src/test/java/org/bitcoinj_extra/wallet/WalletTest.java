...
import org.bitcoinj_extra.core.listeners.TransactionConfidenceEventListener;
...
import org.bitcoinj_extra.signers.StatelessTransactionSigner;
import org.bitcoinj_extra.signers.TransactionSigner;
import org.bitcoinj_extra.store.BlockStoreException;
import org.bitcoinj_extra.store.MemoryBlockStore;
import org.bitcoinj_extra.testing.*;
import org.bitcoinj_extra.utils.ExchangeRate;
import org.bitcoinj_extra.utils.Fiat;
import org.bitcoinj_extra.utils.Threading;
import org.bitcoinj_extra.wallet.Wallet.BalanceType;
import org.bitcoinj_extra.wallet.WalletTransaction.Pool;
...
import org.bitcoinj_extra.wallet.Protos.Wallet.EncryptionType;
...
import static org.bitcoinj_extra.core.Coin.*;
import static org.bitcoinj_extra.core.Utils.HEX;
import static org.bitcoinj_extra.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: bitcoinj_extra won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("bitcoinj_extra-unit-test", null);
    ...
    public void sendCoinsNoBroadcasterTest() throws InsufficientMoneyException {
        ...
        SendRequest req = SendRequest.to((NetworkParameters) OTHER_ADDRESS.getSelectedCoinDetails(), key, SATOSHI.multiply(12));
    ...
    public void sendCoinsWithBroadcasterTest() throws InsufficientMoneyException {
        ...
        SendRequest req = SendRequest.to((NetworkParameters) OTHER_ADDRESS.getSelectedCoinDetails(), key, Coin.CENT);
        wallet.sendCoins(req);
    }
