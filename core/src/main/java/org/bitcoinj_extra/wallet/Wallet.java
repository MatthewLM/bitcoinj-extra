...
package org.bitcoinj_extra.wallet;
...
import org.bitcoinj_extra.core.listeners.*;
import org.bitcoinj_extra.core.AbstractBlockChain;
import org.bitcoinj_extra.core.Address;
import org.bitcoinj_extra.core.BlockChain;
import org.bitcoinj_extra.core.BloomFilter;
import org.bitcoinj_extra.core.Coin;
import org.bitcoinj_extra.core.Context;
import org.bitcoinj_extra.core.ECKey;
import org.bitcoinj_extra.core.FilteredBlock;
import org.bitcoinj_extra.core.InsufficientMoneyException;
import org.bitcoinj_extra.core.Message;
import org.bitcoinj_extra.core.NetworkParameters;
import org.bitcoinj_extra.core.Peer;
import org.bitcoinj_extra.core.PeerFilterProvider;
import org.bitcoinj_extra.core.PeerGroup;
import org.bitcoinj_extra.core.ScriptException;
import org.bitcoinj_extra.core.Sha256Hash;
import org.bitcoinj_extra.core.StoredBlock;
import org.bitcoinj_extra.core.Transaction;
import org.bitcoinj_extra.core.TransactionBag;
import org.bitcoinj_extra.core.TransactionBroadcast;
import org.bitcoinj_extra.core.TransactionBroadcaster;
import org.bitcoinj_extra.core.TransactionConfidence;
import org.bitcoinj_extra.core.TransactionInput;
import org.bitcoinj_extra.core.TransactionOutPoint;
import org.bitcoinj_extra.core.TransactionOutput;
import org.bitcoinj_extra.core.UTXO;
import org.bitcoinj_extra.core.UTXOProvider;
import org.bitcoinj_extra.core.UTXOProviderException;
import org.bitcoinj_extra.core.Utils;
import org.bitcoinj_extra.core.VarInt;
import org.bitcoinj_extra.core.VerificationException;
import org.bitcoinj_extra.core.TransactionConfidence.*;
import org.bitcoinj_extra.crypto.*;
import org.bitcoinj_extra.script.*;
import org.bitcoinj_extra.signers.*;
import org.bitcoinj_extra.utils.*;
import org.bitcoinj_extra.wallet.Protos.Wallet.*;
import org.bitcoinj_extra.wallet.WalletTransaction.*;
import org.bitcoinj_extra.wallet.listeners.KeyChainEventListener;
import org.bitcoinj_extra.wallet.listeners.ScriptsChangeEventListener;
import org.bitcoinj_extra.wallet.listeners.WalletChangeEventListener;
import org.bitcoinj_extra.wallet.listeners.WalletCoinsReceivedEventListener;
import org.bitcoinj_extra.wallet.listeners.WalletCoinsSentEventListener;
import org.bitcoinj_extra.wallet.listeners.WalletEventListener;
import org.bitcoinj_extra.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bitcoinj_extra.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.bitcoinj_extra.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.bitcoinj_extra.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj_extra.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.bitcoinj_extra.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.bitcoinj_extra.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj_extra.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.bitcoinj_extra.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.bitcoinj_extra.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.bitcoinj_extra.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj_extra.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.bitcoinj_extra.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.bitcoinj_extra.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj_extra.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of bitcoinj_extra. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bitcoinj_extra.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.bitcoinj_extra.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.bitcoinj_extra.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.bitcoinj_extra.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.bitcoinj_extra.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.bitcoinj_extra.crypto.KeyCrypter,
     ...
     * {@link org.bitcoinj_extra.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.bitcoinj_extra.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.bitcoinj_extra.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.bitcoinj_extra.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.bitcoinj_extra.core.TransactionBroadcaster broadcaster) {
