...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link org.bitcoinj_extra.wallet.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the bitcoinj_extra protobuf format. */
     ...
     *
     * <p>See the docs for {@link org.bitcoinj_extra.core.BloomFilter#BloomFilter(int, double, long)} for a brief
