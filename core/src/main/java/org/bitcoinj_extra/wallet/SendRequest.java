...
import org.bitcoinj_extra.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.bitcoinj_extra.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.bitcoinj_extra.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
    ...
    public static SendRequest to(Address destination, Coin value) {
        ...
        final NetworkParameters parameters = (NetworkParameters) destination.getSelectedCoinDetails();
