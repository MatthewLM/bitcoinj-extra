...
/**
 * <p>A KeyChainGroup is used by the {@link org.bitcoinj_extra.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.bitcoinj_extra.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.bitcoinj_extra.crypto.KeyCrypterScrypt}.
     *
     * @throws org.bitcoinj_extra.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
