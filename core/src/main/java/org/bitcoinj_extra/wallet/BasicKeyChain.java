...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.bitcoinj_extra.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.bitcoinj_extra.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.bitcoinj_extra.crypto.KeyCrypter,
