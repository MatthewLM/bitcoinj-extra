 ...
 * {@link org.bitcoinj_extra.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.bitcoinj_extra.crypto.MnemonicCode},
 ...
 * {@link org.bitcoinj_extra.crypto.DeterministicKey#serializePubB58(org.bitcoinj_extra.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.bitcoinj_extra.crypto.DeterministicKey#deserializeB58(org.bitcoinj_extra.crypto.DeterministicKey, String, org.bitcoinj_extra.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.bitcoinj_extra.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.bitcoinj_extra.crypto.DeterministicHierarchy} and
 * {@link org.bitcoinj_extra.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from bitcoinj_extra users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.bitcoinj_extra.crypto.DeterministicKey)}
     ...
     * @see org.bitcoinj_extra.wallet.MarriedKeyChain
     */
