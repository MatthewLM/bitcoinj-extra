...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(org.bitcoinj_extra.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link org.bitcoinj_extra.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link org.bitcoinj_extra.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
