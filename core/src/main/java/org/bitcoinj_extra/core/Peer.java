...
import org.bitcoinj_extra.net.StreamConnection;
import org.bitcoinj_extra.store.BlockStore;
import org.bitcoinj_extra.store.BlockStoreException;
import org.bitcoinj_extra.utils.ListenerRegistration;
 ...
 * {@link org.bitcoinj_extra.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.bitcoinj_extra.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.bitcoinj_extra.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.bitcoinj_extra.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.bitcoinj_extra.core.TxConfidenceTable}
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // bitcoinj_extra is a client mode implementation. That means there's not much point in us talking to other client
     ...
     * Once the pong is received the value returned by {@link org.bitcoinj_extra.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.bitcoinj_extra.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.bitcoinj_extra.core.Peer#ping()} has never
