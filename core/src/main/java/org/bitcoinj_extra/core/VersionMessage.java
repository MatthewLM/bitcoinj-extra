...
public class VersionMessage extends Message {
    ...
    public static final String LIBRARY_SUBVER = "/bitcoinj_extra:" + BITCOINJ_VERSION + "/";
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for bitcoinj_extra
     * users might look like "/bitcoinj_extra:0.13/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/bitcoinj_extra:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
