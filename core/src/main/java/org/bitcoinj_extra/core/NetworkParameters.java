...
import org.bitcoinj_extra.params.*;
...
import org.bitcoinj_extra.utils.VersionTally;
...
public abstract class NetworkParameters extends CoinDetails implements Serializable {
    ...
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.bitcoinj_extra.unittest";
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.bitcoinj_extra.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.bitcoinj_extra.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.bitcoinj_extra.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.bitcoinj_extra.core.AlertMessage}s. You can use {@link org.bitcoinj_extra.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
