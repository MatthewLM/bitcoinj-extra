...
import org.bitcoinj_extra.store.FullPrunedBlockStore;
 ...
 * {@link org.bitcoinj_extra.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with bitcoinj_extra */
    ...
    /** Returns a checkpoints stream pointing to inside the bitcoinj_extra JAR */
