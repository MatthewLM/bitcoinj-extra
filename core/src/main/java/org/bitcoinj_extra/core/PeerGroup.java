...
import org.bitcoinj_extra.net.*;
import org.bitcoinj_extra.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of bitcoinj_extra fixes the known
     ...
     * {@link org.bitcoinj_extra.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.bitcoinj_extra.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.bitcoinj_extra.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.bitcoinj_extra.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.bitcoinj_extra.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.bitcoinj_extra.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.bitcoinj_extra.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * and easy way for a user to upgrade a bitcoinj_extra based app running in SPV mode to fully validating security.
     */
