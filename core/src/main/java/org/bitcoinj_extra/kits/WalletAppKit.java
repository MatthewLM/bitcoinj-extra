...
package org.bitcoinj_extra.kits;
...
import org.bitcoinj_extra.protocols.channels.*;
import org.bitcoinj_extra.store.*;
import org.bitcoinj_extra.wallet.*;
import org.slf4j.*;
 ...
 * It is to make it easier to fit bitcoinj_extra into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing bitcoinj_extra
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link org.bitcoinj_extra.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the bitcoinj_extra website for further details.
     */
