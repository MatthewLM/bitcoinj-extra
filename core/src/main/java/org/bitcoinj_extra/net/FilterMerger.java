...
package org.bitcoinj_extra.net;
...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.bitcoinj_extra.core.PeerFilterProvider}s, a merged
 * {@link org.bitcoinj_extra.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.bitcoinj_extra.core.PeerGroup} class internally.</p>
 *
