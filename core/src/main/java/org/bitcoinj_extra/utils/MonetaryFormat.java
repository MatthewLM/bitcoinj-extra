...
public final class MonetaryFormat {
    ...
    public CharSequence format(Monetary monetary) {
        ...
        int decLen = smallestUnitExponent - shift;
    ...
    /**
     * Parse a human readable coin value to a {@link org.bitcoinj_extra.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.bitcoinj_extra.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
    ...
    /**
     * Gets a {@link org.bitcoinj_extra.shapeshift.ShapeShiftMonetary} for a string formatted with the MonetaryFormat
     *
