...
package org.bitcoinj_extra.utils;
 ...
 * bitcoinj_extra performs cycle detection or not. Cycle detection is useful to detect bugs but comes with a small cost.
...
public class Threading {
     ...
     * bitcoinj_extra internally shouldn't normally run here, although currently there are a few exceptions.
     */
     ...
     * bitcoinj_extra library code is run, setting it after you started network traffic and other forms of processing
    ...
    public static class UserThread extends Thread implements Executor {
        ...
        public UserThread() {
            super("bitcoinj_extra user thread");
            setDaemon(true);
    ...
    static {
        ...
        // instantiating any bitcoinj_extra objects. The policy change will take effect only on new objects
